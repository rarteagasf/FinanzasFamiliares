              ...
              {displayedExpenses.map(expense => {
                ...
                return (
                  <tr key={expense.id} onDoubleClick={() => !isEditing && startInlineEditing(expense)}>
                    {isEditing ? (
                      <>
                        <td><input type="number" className="input" style={{ width: '60px', padding: '0.25rem' }} value={inlineForm.dia} onChange={e => setInlineForm({...inlineForm, dia: parseInt(e.target.value)})} min="1" max="31" /></td>
                        ...
                        <td><input type="number" step="0.01" className="input" style={{ width: '100px', padding: '0.25rem' }} value={inlineForm.importe} onChange={e => setInlineForm({...inlineForm, importe: parseFloat(e.target.value)})} /></td>
                        <td>
